...
### MySQL
MySQL is used to store all of the leaderboard data for each season. This database archive is stored in the `./archive` directory and is available in this github repository.
