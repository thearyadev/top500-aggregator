...
import {
    ...
    get_season_list,
    get_gini_coefficient_trend_lines,
} from "../server/actions";

const TrendsPage = async () => {
    const seasonalOccurrencesTrend = await get_occurrence_trend_lines();
    const seasonalOccurrencesTrendWeighted =
        await get_occurrence_trend_lines(true);
    const seasonalGiniCoefficientTrend =
        await get_gini_coefficient_trend_lines();
        ...
        <main>
            ...
            <Card title={"Seasonal Trends"} nowrap>
                ...
                <LineChart
                    ...
                    data={seasonalGiniCoefficientTrend}
                    seasons={seasonList}
                    title={
                        "Gini Coefficient: By Role All Regions, First Most Played"
                    }
                    className=""
                />
            </Card>
